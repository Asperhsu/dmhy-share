        ...
        <table class="table table-striped mb-0">
            ...
            <tbody>
                <tr v-for="program in programs" :key="program.id">
                    <td v-text="program.season"></td>
                    <td v-text="program.title"></td>
                    <td v-text="program.url"></td>
                    <td>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            store () {
                this.$firestoreRefs.programs.add(this.formData);
            },
            edit (source) {
            ...
            update () {
                ...
                this.$firestoreRefs.programs.doc(this.editingId).set(this.formData);
            },
            destroy (source) {
                if (window.confirm('Confirm Delete: ' + source.season)) {
                    this.$firestoreRefs.programs.doc(source.id).delete();
                }
            },
        },
    }
